...
from mathematics.geometry.coxA3 import CoxA3
...
def generate_data():
    ...
    t0 = 0
    path = "data"
    group = CoxA3(path=path)

    data = read_signatures(os.path.join(path,"CoxA3_signatures.dat"))
    ...
    [1,1,1]->octahedron
    [1,1,0]->cuboctahedron
    [1,1,-1]->truncated octahedron
    [1,0,1]->tetrahedron
    [1,0,0]->tetrahedron
    [1,0,-1]->truncated tetrahedron
    [1,-1,1->cuboctahedron
    [1,-1,0]->octahedron
    [1,-1,-1]->cuboctahedron
    [0,1,1]->tetrahedron
    [0,1,0]->tetrahedron
    [0,1,-1]->truncated tetrahedron
    [0,0,1]->octahedron
    """
