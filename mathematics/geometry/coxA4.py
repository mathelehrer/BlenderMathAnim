...
class CoxA4:
    ...
    def get_cells(self, seed=[1, 1, 1, 1]):
        ...
        active_elements = {}
        active_elements[point_cloud[0]] = FMatrix.identity(4, root_modulus=5, root_string="r5")
    ...
    def get_cells_in_conjugacy_classes(self, signature=COXA4_SIGNATURES["x3x3x3x"]):
        """
