...
file = open("C:/Users/p6maj/Dropbox/MyBlender/nPendulum/PendulumBigLeft.csv", "r")
bigLeftData = file.readlines()
file.close()
    
# make big Right dynamic    
file = open("C:/Users/p6maj/Dropbox/MyBlender/nPendulum/PendulumBigRight.csv", "r")
bigRightData = file.readlines()
file.close()
     
# make outer Left dynamic    
file = open("C:/Users/p6maj/Dropbox/MyBlender/nPendulum/PendulumOuterLeft.csv", "r")
outerLeftData = file.readlines()
file.close()

# make outer Right dynamic    
file = open("C:/Users/p6maj/Dropbox/MyBlender/nPendulum/PendulumOuterRight.csv", "r")
outerRightData = file.readlines()
file.close()
  
# make inner Left dynamic    
file = open("C:/Users/p6maj/Dropbox/MyBlender/nPendulum/PendulumInnerLeft.csv", "r")
innerLeftData = file.readlines()
file.close()
  
# make inner Right dynamic    
file = open("C:/Users/p6maj/Dropbox/MyBlender/nPendulum/PendulumInnerRight.csv", "r")
...
total_time = 25 # Animation should be 2*pi seconds long
...
for i in range(0,dim-1):
    ...
    bpy.ops.mesh.primitive_cylinder_add(vertices=8, radius=0.01, depth=lOuterLeft[i+1], enter_editmode=False, align='WORLD', location=middle, scale=(1, 1, 1))
    obj = bpy.context.active_object
    ...
    phis=[float(line[1]),float(line[2]),float(line[3]),float(line[4])]
    bpy.ops.mesh.primitive_cylinder_add(vertices=8, radius=0.01, depth=lOuterRight[i+1], enter_editmode=False, align='WORLD', location=middle, scale=(1, 1, 1))
    obj = bpy.context.active_object
    obj.rotation_euler[0]=1.5708
    obj.rotation_euler[2]=-phis[i+1]
    obj.data.materials.append(get_material((0.00318879,0.8, 0, 1)))
...
for i in range(0,dim-1):
    ...
    phis=[float(line[1]),float(line[2]),float(line[3]),float(line[4])]
    bpy.ops.mesh.primitive_cylinder_add(vertices=8, radius=0.01, depth=lInnerLeft[i+1],
     enter_editmode=False, align='WORLD', location=middle, scale=(1, 1, 1))
    obj = bpy.context.active_object
    obj.rotation_euler[0]=1.5708
    obj.rotation_euler[2]=-phis[i+1]
    obj.data.materials.append(get_material((0.00318879, 0.,0.8, 1)))
    ...
    phis=[float(line[1]),float(line[2]),float(line[3]),float(line[4])]
    bpy.ops.mesh.primitive_cylinder_add(vertices=8, radius=0.01, depth=lInnerRight[i+1], enter_editmode=False, align='WORLD', location=middle, scale=(1, 1, 1))
    obj = bpy.context.active_object
    obj.rotation_euler[0]=1.5708
    obj.rotation_euler[2]=-phis[i+1]
    obj.data.materials.append(get_material((0.00318879, 0., 0.8, 1)))
