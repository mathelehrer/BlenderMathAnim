...
def hat_tile_fractal(**kwargs):
    ...
    custom_ops = {
        "mix": {
            ...
            "settings": {"data_type": "VECTOR", "factor_mode": "UNIFORM",
                         "clamp_factor": False},
            "inputs": ("A", "B","Factor"),  # ternary: Factor is the 3rd pop, but in rpn notation it is written first
            "output": "Result",
            "label": "mix",
        },
        "onRight":{
    ...
    make_aux1 = make_function_with_aux(tree,name="aux1",
                                       aux_functions={
                                           "e1":f"1,{phi2},/,b,a,mix",
                                            "e2":f"{phim1},c,d,mix"
    ...
    make_aux2 = make_function_with_aux(tree, name="aux2",
                                        custom_ops=custom_ops, functions={
            "a1":f"{phim1},a,e1,mix",
            "b1":f"{phim1},d,e1,mix",
            "c1":f"{phim1},d,e1,mix",
    ...
    make_cond = make_function_with_aux(tree, name="cond",
                                       custom_ops=custom_ops, functions={
    ...
    update_variables = make_function_with_aux(tree, name="exitCheck",custom_ops=custom_ops,
                                           functions={
                                           ...
                                           scalars=variables_scalar+ update_scalars,
