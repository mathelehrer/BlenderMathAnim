...
if color_scheme == -1:
    ...
    COLORS = [
        ...
        # palette with brighter colors

        # [127,255,0,1],  # tetra
        # [0,255,127,1],
        # [0,255,255,1], # octa
        # [127,255,255,1], # cubocta
        # [255,255,127,1], # trunc octa
        #
        # [0,0,255,1], # hexa
        # [0,127,255,1],
        # [127,0,255,1],
        ...
        # [255,64,64,1], # dodeca
        # [255,0,0,1], # icosa
        # [255,127,127,1], # icosidodeca
        # [255,127,0,1],
        # [255,255,0,1],
        # [255,0,127,1],
        # [255,0,255,1],
        #
        # [255,255,255,1],# three prism
        # [220,220,220,1],
        # [195,195,195,1],
        # [170,170,170,1],
        # [145,145,145,1],
        ...
        [0, 255, 0, 1],  # tetra
        [64,127,64,1], #[127, 127, 0, 1],
        [0, 127, 127, 1],  # octa
        [0, 127, 255, 1],  # cubocta
        [0, 255, 127, 1],  # trunc octa
        [255,255,0,1], #[0, 0, 255, 1],  # hexa
        [0, 255, 127, 1],
        [0, 255, 255, 1],
        [127, 0, 255, 1],
        [255, 0, 0, 1],  # dodeca
        ...
        # brighter prisms for crystal renderer
        # [255,255,255,1],# three prism
        # [255,255,255,1],# four prism
        # [255,255,255,1],# five prism
        # [255,255,255,1],# six prism
        # [255,255,255,1],# eight prism
        # [255,255,255,1],# ten prism
...
RES_XML2 = os.path.join(RES_DIR2, "xml")
