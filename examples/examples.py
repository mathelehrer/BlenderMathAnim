...
from geometry_nodes.geometry_nodes_modifier import LegendrePolynomials, AssociatedLegendreP, \
    PlmSurface, YlmSurface, YlmSurfaceReference, YlmSurface_200
...
class Examples(Scene):
    ...
    def test_hash(self):
        t0 = 0
        test_text = SimpleTexBObject(r"\int\limits_{0}^{2\pi}\sin\varphi{\rm d}\varphi=0", color="example",
                                     text_size='Huge')
        test_text.write(begin_time=t0, transition_time=10)
        self.t0 = t0
