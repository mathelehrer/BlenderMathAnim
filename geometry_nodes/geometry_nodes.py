...
def create_pendulum_node():
    ...
    tree = setup_geometry_nodes("Pendulum", group_input=False)
    ...
    min_frame = InputValue(tree, location=(left,- 1), name="maxFrame", value=120)
    max_frame = InputValue(tree, location=(left,- 1.25), name="maxFrame", value=620)
    ...
    left += 1
    arc_mat = SetMaterial(tree, location=(left, -6), material=gradient_from_attribute, attr_name="thetaStorage",
                          roughness=0.1, metallic=0.5)
    ...
    left += 1
    graph_mat = SetMaterial(tree, location=(left, y),
