...
def get_texture_material():
    ...
    node_coord.location=Vector((1200,250))
    
    
    node_tex = nodes.new(type="ShaderNodeTexImage")
    node_tex.location=Vector((1500,250))
    image = bpy.data.images.load(filepath="/home/jmartin/Dropbox/MyBlender/ComplexSurfaces//earth_texture1to1_hi.jpg")
    node_tex.image = image
    
    links =material.node_tree.links
    links.new(node_coord.outputs[0],node_tex.inputs[0])
    links.new(node_tex.outputs[0],bsdf.inputs[17])
